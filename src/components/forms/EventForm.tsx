      ...
      footer={
        <>
          ...
          <button
            ...
            className="rounded-lg bg-primary px-5 py-1.5 text-[0.8125rem] font-medium text-primary-foreground shadow-sm transition-all duration-150 hover:bg-primary/90 focus:ring-2 focus:ring-ring/30 focus:ring-offset-1"
          >
