...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const commands: Command[] = [
    ...
    { id: 'nav-contracts', label: 'Go to Contracts', icon: <Icons.FileText size={16} />, action: () => navigate('/contracts'), category: 'Navigation' },
    { id: 'nav-field-service', label: 'Go to Field Service', icon: <Icons.Briefcase size={16} />, action: () => navigate('/field-service'), category: 'Navigation' },
    ...
    { id: 'nav-forecasting', label: 'Go to Forecasting', icon: <Icons.TrendingUp size={16} />, action: () => navigate('/forecasting'), category: 'Navigation' },
    { id: 'nav-revenue-ops', label: 'Go to Revenue Ops', icon: <Icons.Gauge size={16} />, action: () => navigate('/revenue-ops'), category: 'Navigation' },
    ...
    { id: 'action-new-contract', label: 'Create New Contract', icon: <Icons.FileText size={16} />, action: () => navigate('/contracts?create=1'), category: 'Actions' },
    { id: 'action-new-work-order', label: 'Create Work Order', icon: <Icons.Briefcase size={16} />, action: () => navigate('/field-service?create=1'), category: 'Actions' },
