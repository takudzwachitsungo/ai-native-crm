...
export function Modal({ isOpen, onClose, title, children, size = 'md', footer }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      <div className={cn("relative flex max-h-[calc(100dvh-1.5rem)] w-full flex-col overflow-hidden rounded-lg bg-card shadow-lg sm:max-h-[calc(100dvh-2rem)]", sizeClasses[size])}>
