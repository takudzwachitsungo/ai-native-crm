...
function getDealBadges(deal: PipelineDeal): InsightBadgeView[] {
...
export default function PipelinePage() {
  ...
  const { insights } = useInsights("pipeline");
  ...
  const getCanonicalDealBadges = (deal: PipelineDeal) => {
        ...
        <div className="flex min-w-max gap-3">
          {filteredStages.map((stage) => (
            <div
              ...
              className={cn(
                "w-[82vw] bg-card border border-border rounded-2xl flex-shrink-0 transition-all sm:w-[18rem]",
