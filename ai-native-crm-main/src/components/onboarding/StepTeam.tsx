...
const USER_COUNT_OPTIONS = ['1–5', '6–20', '21–50', '50+'];
    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        <label className="block text-[0.75rem] font-medium text-gray-700">
          <span className="flex items-center gap-1.5"><Users size={14} /> How many people will use the CRM?</span>
        </label>
      ...
      <div className="space-y-1">
        <label htmlFor="ob-invite" className="block text-[0.75rem] font-medium text-gray-700">
          <span className="flex items-center gap-1.5"><Mail size={14} /> Invite teammates</span>
        </label>
        <textarea
          id="ob-invite"
          rows={2}
