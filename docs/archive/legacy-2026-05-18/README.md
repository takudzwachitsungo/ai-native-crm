...
#### [AI_GOVERNANCE_AND_COPILOT.md](./AI_GOVERNANCE_AND_COPILOT.md)
**Current AI copilot capabilities, audit logging, safe actions, and insight lifecycle**
- AI service boundary with the Java backend
- Audit event storage and governance endpoints
- Confirmed AI action proposal/execution flow
- Insight dismiss, snooze, assign, and active lifecycle states
- RAG indexing, scheduler operations, and AI alert thresholds
- Remaining enterprise AI roadmap
- **When to read**: When working on AI trust, copilot actions, admin controls, or insight lifecycle behavior
...
2. Read [AI_GOVERNANCE_AND_COPILOT.md](./AI_GOVERNANCE_AND_COPILOT.md)
3. Follow "Adding New Features" section for agents or tools
